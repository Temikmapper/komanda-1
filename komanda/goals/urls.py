...
urlpatterns = [
    ...
    path(
        "<int:goal_id>/expenses/<int:goal_expense_id>/delete",
        views.delete_goal_expense,
        name="delete_goal_expense",
    ),
    path("<int:id>/bumps", views.goal_bumps, name="goal_bumps"),
    path(
        "<int:goal_id>/bumps/<int:goal_bump_id>/delete",
        views.delete_goal_bump,
        name="delete_goal_bump",
    ),
